...
class FileSystem(object):
    ...
    def get_path(self, name: str, force: bool = False) -> str:
        ...
        force : bool, optional
            Whether to force the creation of the directory.
        """
        if name.startswith('/'):
            return name
    ...
    def assure_local_file(name: str, force: bool = False) -> str:
        ...
        if not fs_loc.exists(name) or force:
            fs_rem = app.fs
    ...
    def save_image(self, image: Any, name: str) -> str:
        """
        Save the given image to a file as bytes.
